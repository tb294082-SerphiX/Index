...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://96996221383616",
...
gz.Image = "rbxassetid://96996221383616";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">Phantom Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	r.Image = "rbxassetid://96996221383616";
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">Phantom Hub </font> : Blox Fruits");
	...
	y.Image = "rbxassetid://96996221383616";
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://96996221383616";
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Phantom Hub </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
